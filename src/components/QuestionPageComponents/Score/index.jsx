...
function Score({
  ...
  let percentage =
    (correctResponseCount / (correctResponseCount + inCorrectResponseCount)) *
    100;
  ...
  return (
    <div className="c-score-wrapper">
      <div className="c-heading">{headerText}</div>
      <div className="c-score-section">
        <div className="c-score-percentage-wrapper">
          <div className="c-score-percentage" style={componentStyle}>
            ...
            {percentage}%{/** For making semi circle shape */}
      ...
      <ScoreCard
        purpose={"correct"}
        purposeText={"Correct"}
        responseCount={correctResponseCount}
      />
      <ScoreCard
        purpose={"incorrect"}
        purposeText={"Incorrect"}
        responseCount={inCorrectResponseCount}
      />
